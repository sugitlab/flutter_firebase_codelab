...
class ApplicationState extends ChangeNotifier {
  ...
  // Need more...
  // It must be noted that this isn't a complete implementation of the FirebaseUI Auth flow,
  // as it does not handle the case of a user with an existing account who is having trouble logging in.
  // Implementing this additional capability is left as an exercise to the motivated reader.
